  ...
  return (
    <div className=''>
        ...
        <div id='bidang' className='flex flex-col justify-center items-center lg:flex-row gap-10 lg:gap-0 my-10 mx-auto py-10 lg:px-24 h-fit'>
            <div id='slide-bidang' className='w-full md:w-3/5  gap-2'>
                
                <SwiperBidang />
            </div>
            <div className='vismis w-5/6 h-64 md:h-fit md:w-2/5 flex flex-col justify-center items-center px-14 md:px-0'>
                <div className='visi w-full relative text-center cursor-pointer'>
                ...
                <div className='misi w-full relative text-center cursor-pointer'>
        ...
        >
            ...
            <div className='bg-light bg-opacity-10 p-5 rounded-2xl ring-1 ring-opacity-20 ring-light'>
                <SwiperActivities />
            </div>
        ...
        <div className='w-full h-fit p-10 md:px-14'>
            <p className={`w-full text-5xl md:text-7xl font-semibold text-center lg:text-start ${textGrandientStyleSun}`}>Our <span className={`${textGrandientStyle}`}>Benefits</span> </p>
            <div className='w-full h-fit py-10 grid grid-cols-1 lg:grid-cols-3 place-items-center items-center gap-8'>
